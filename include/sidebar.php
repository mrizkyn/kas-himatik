...
<aside class="main-sidebar sidebar-light-primary elevation-4">
  ...
  <a href="index.php" class="brand-link">
    <img src="assets/img/img_properties/hima.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-0" style="opacity: 1">
    <span class="brand-text font-weight-light">KAS HIMATIK</span>
  </a>
