                  ...
                  <?php endif ?>
                    ...
                    <?php else: ?>
                      <td>
                        ...
                        <?php else: ?>
                          <a href="" data-toggle="modal" data-target="#editMingguKe1<?= $duk['id_uang_kas']; ?>" class="badge badge-danger"> Bayar_ <?= number_format($duk['minggu_ke_1']); ?></a>
                        <?php endif ?>
                      </td>
                    <?php endif ?>
                    <?php if ($duk['minggu_ke_1'] !== $duk['pembayaran_perminggu']): ?>
                    ...
                    <?php else: ?>
                      ...
                      <?php endif ?>
                      <?php else: ?>
                        <td><a href="" data-toggle="modal" data-target="#editMingguKe2<?= $duk['id_uang_kas']; ?>" class="badge badge-danger">Bayar_ <?= number_format($duk['minggu_ke_2']); ?></a></td>
                      <?php endif ?>
                      <?php if ($duk['minggu_ke_2'] !== $duk['pembayaran_perminggu']): ?>
                        <td><---</td>
                        <td><---</td>
                      <?php else: ?>
                        <?php if ($duk['minggu_ke_3'] == $duk['pembayaran_perminggu']): ?>
                          ...
                          <?php endif ?>
                        <?php else: ?>
                          <td><a href="" data-toggle="modal" data-target="#editMingguKe3<?= $duk['id_uang_kas']; ?>" class="badge badge-danger">Bayar_ <?= number_format($duk['minggu_ke_3']); ?></a></td>
                        <?php endif ?>
                        <?php if ($duk['minggu_ke_3'] !== $duk['pembayaran_perminggu']): ?>
                          <td><---</td>
                        <?php else: ?>
                          ...
                          <?php else: ?>
                            <td><a href="" data-toggle="modal" data-target="#editMingguKe4<?= $duk['id_uang_kas']; ?>" class="badge badge-danger">Bayar_ <?= number_format($duk['minggu_ke_4']); ?></a></td>
                          <?php endif ?>
                        <?php endif ?>
                      <?php endif ?>
                    <?php endif ?>
