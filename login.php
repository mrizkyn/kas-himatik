  ...
  if (isset($_POST['btnLogin'])) {
  	...
  	if ($data = mysqli_fetch_assoc($checkUsername)) {
  		if (password_verify($password, $data['password'])) {
			...
			setAlert("Password yang Anda masukan salah!", "Periksa Kembali Password Anda!", "error");
			header("Location: login.php");
	  	}
  	} else {
		setAlert("Username yang Anda Masukan tidak Terdaftar!", "Periksa Kembali Username Anda!", "error");
		header("Location: login.php");
  	}
  }
?>
...
<body>
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-4 mx-5 py-4 px-5 text-dark rounded border border-dark" style="background-color: #D2E1ED">
				<h3 class="text-center">KAS HIMATIK</h3>
				<form method="post">
